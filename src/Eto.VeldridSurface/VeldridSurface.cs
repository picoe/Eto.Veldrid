...
namespace Eto.VeldridSurfaceCUSTOMCONTROLTEST
{
	public static class VeldridGL
	{
		public static Dictionary<IntPtr, GLSurface> Contexts = new Dictionary<IntPtr, GLSurface>();
	...
	[Handler(typeof(IVeldridSurface))]
	public class VeldridSurface : Panel
	{
		public interface IVeldridSurface : Container.IHandler
		{
			void Skiboodle(bool fail);
		}

		new IVeldridSurface Handler => (IVeldridSurface)base.Handler;
